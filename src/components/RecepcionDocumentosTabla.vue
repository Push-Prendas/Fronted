        ...
        <div style="padding:50px; margin-left:300px">
          ...
          <tbody class="bodyTabla"  v-for="(item,index) in items" :key="index" >
            <tr>
              ...
              <th >{{item.Fecha}}</th>
              <th >{{item.Estado}}</th>
              <th><b-button v-b-modal.modal-6 class="col buttonAdd d-flex justify-content-center"><font-awesome-icon style= "margin-right:5px" icon="file-download" /></b-button></th>
            </tr>
          </tbody>
        </table>
        </div>
        ...
        <b-modal id="modal-6"  hide-footer style="width:80px;">
          <div class="row">
            ...
            <div class="input-group mb-3 " >
                <label  for="anexos"></label><input type="file" class="form-control" id="anexos" >
